        ...
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/3">
            <div className="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="bg-gray-200 animate-pulse h-4 w-1/4 mb-2"></div>
                ...
                <div className="flex items-center flex-wrap ">
                  <div className="bg-indigo-200 h-4 animate-pulse mt-2 w-32 inline-flex items-center md:mb-2 lg:mb-0"></div>
